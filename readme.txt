...
Use shortcode [haiku_player url="http://example.com/file.mp3" title="Title of audio file"] to play an audio file. Be sure to use the full URL to the audio file. Title is optional.
